...
# Introductry HTML & JAVA script

# Structure 
Each element in HTML has an opening tag and a closing tag,Tags act like containers. They tell you something about the information that lies between their opening and closing tags.

### **A Closer Look at Tags**
![opentag](/image/opentag.bmp)
![clostag](/image/clostag.bmp)
...
user interacts with the web ,age.
...
![flowchart](/image/ex1.bmp)
![flowchartkeys](/image/ex2.bmp)
